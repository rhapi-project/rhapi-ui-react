...
export default class Tarification extends React.Component {
  ...
  render() {
    ...
    let acte = _.isUndefined(this.props.detail.acte) ? null : (
      <Table.Row>
        <Table.Cell>
          <Header as="h3" content="Acte" />
        </Table.Cell>
        <Table.Cell>
          <strong>Code : </strong>{" "}
          {_.isUndefined(this.props.detail.acte.codActe)
            ? ""
            : this.props.detail.acte.codActe}{" "}
          <br />
          <strong>Nom : </strong>{" "}
          {_.isUndefined(this.props.detail.acte.nomLong)
            ? ""
            : this.props.detail.acte.nomLong}{" "}
          <br />
        </Table.Cell>
      </Table.Row>
    );
      ...
      <Table.Row>
        ...
        <Table.Cell>
          ...
          {_.isUndefined(this.props.detail.activite.codActiv)
            ...
            : this.props.detail.activite.codActiv}{" "}
          <br />
          <strong>Libellé : </strong>{" "}
          {_.isUndefined(this.props.detail.activite.libelle)
            ? ""
            : this.props.detail.activite.libelle}
        </Table.Cell>
      </Table.Row>
    );
      ...
      <Table.Row>
        ...
        <Table.Cell>
          ...
          {_.isUndefined(this.props.detail.grille.codGrille)
            ...
            : this.props.detail.grille.codGrille}{" "}
          <br />
          <strong>Définition : </strong>{" "}
          {_.isUndefined(this.props.detail.grille.definition)
            ? ""
            : this.props.detail.grille.definition}{" "}
          <br />
          <strong>Libellé : </strong>{" "}
          {_.isUndefined(this.props.detail.grille.libelle)
            ? ""
            : this.props.detail.grille.libelle}
        </Table.Cell>
      </Table.Row>
    );
    ...
    let modificateurs = _.isEmpty(this.props.detail.modificateurs) ? null : (
      <Table.Row>
        <Table.Cell>
          <Header as="h3" content="Modificateurs" />
        </Table.Cell>
        <Table.Cell>
            ...
            <Table.Body>
              {_.map(this.props.detail.modificateurs, modificateur => (
                <Table.Row key={modificateur.codModifi}>
                  <Table.Cell>
                    <strong>Code modificateur : </strong>{" "}
                    {modificateur.codModifi} <br />
                    <strong>Coefficient : </strong> {modificateur.coef} <br />
                    <strong>Date début : </strong>{" "}
                    {_.isNull(modificateur.dtDebut)
                      ? "Indéterminée"
                      : this.convertDate(modificateur.dtDebut)}{" "}
                    <br />
                    <strong>Date fin : </strong>{" "}
                    {_.isNull(modificateur.dtFin)
                      ? "Indéterminée"
                      : this.convertDate(modificateur.dtFin)}{" "}
                    <br />
                    <strong>Forfait : </strong> {modificateur.forfait} <br />
                    <strong>Code de la grille : </strong>{" "}
                    {modificateur.grilleCod} <br />
      ...
      <Table.Row>
        ...
        <Table.Cell>
          ...
          {_.isUndefined(this.props.detail.phase.codPhase)
            ...
            : this.props.detail.phase.codPhase}{" "}
          <br />
          <strong>Libellé : </strong>{" "}
          {_.isUndefined(this.props.detail.phase.libelle)
            ? ""
            : this.props.detail.phase.libelle}
        </Table.Cell>
      </Table.Row>
    );
    ...
    let tarif = _.isUndefined(this.props.detail.tarif) ? null : (
      <Table.Row>
        <Table.Cell>
          <Header as="h3" content="Tarif" />
        </Table.Cell>
        <Table.Cell>
          <strong>Pu base : </strong>{" "}
          {_.isUndefined(this.props.detail.tarif.puBase)
            ? ""
            : this.props.detail.tarif.puBase.toFixed(2) + " €"}{" "}
          <br />
          <strong>Pu : </strong>{" "}
          {_.isUndefined(this.props.detail.tarif.pu)
            ? ""
            : this.props.detail.tarif.pu.toFixed(2) + " €"}{" "}
          <br />
        </Table.Cell>
      </Table.Row>
    );
