...
import { Actes, Shared } from "../../Components";
...
export default class ActesNote extends React.Component {
  ...
  onUpdate = newActe => {
    ...
    let index = _.findIndex(
      currentActes,
      acte => acte.id === newActe.id && acte.lockRevision < newActe.lockRevision
    );
  ...
  render() {
    let iconNote = <Icon name="sticky note outline" size="large" />;

    let iconTodo = <Icon name="list" size="large" />;
