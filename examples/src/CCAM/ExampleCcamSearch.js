...
export default class ExampleCcamSearch extends React.Component {
  render() {
    return(
      <div>
        <div>
          Un pétit descriptif de comment ce composant fonction, les props, les fonctions callbacks etc. <br />
